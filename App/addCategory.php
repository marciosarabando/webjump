<?php
  ...
  if(isset($_POST['save'])){
    $categoria->setCodigo($_POST['category-code']);
    $categoria->setNome($_POST['category-name']);
  ...
  <main class="content">
    ...
    <form name="formCategoria" action="" method="post">
      <div class="input-field">
        ...
        <input type="text" id="category-name" name="category-name" class="input-text" value="<?=$categoria->getNome() ?>" />
        
      </div>
      <div class="input-field">
        <label for="category-code" class="label">Category Code</label>
        <input type="text" id="category-code" name="category-code" class="input-text" value="<?=$categoria->getCodigo() ?>" />
