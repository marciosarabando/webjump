...
if(isset($_GET['funcao']) && $_GET['funcao'] == "edit"){
    header("location: /addCategory.php?funcao=edit&id={$_GET['id']}");
}
...
<!-- Header --><body>
  ...
  <main class="content">
    ...
    <table class="data-grid">
      ...
      <?php foreach($categoria->getAll() as $cat) { ?>
        <tr class="data-row">
          <td class="data-grid-td">
            <span class="data-grid-cell-content"><?=$cat->getNome() ?></span>
          </td>
        
          <td class="data-grid-td">
            <span class="data-grid-cell-content"><?=$cat->getCodigo() ?></span>
          </td>
        
          <td class="data-grid-td">
            <div class="actions">
              <div class="action edit"><a href="categories.php?funcao=edit&id=<?=$cat->getId() ?>"<span>Edit</span></a></div>
              <div class="action delete"><a href="categories.php?funcao=delete&id=<?=$cat->getId() ?>"<span>Delete</span></a></div>
            </div>
          </td>
        </tr>
      <?php } ?>
