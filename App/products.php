...
if(isset($_GET['funcao']) && $_GET['funcao'] == "edit"){
  header("location: /addProduct.php?funcao=edit&id={$_GET['id']}");
}

if(isset($_GET['funcao']) && $_GET['funcao'] == "delete"){
if($produto->delete($_GET['id'])){
...
<!-- Header --><body>
  ...
  <main class="content">
    ...
    <?php foreach($produto->getAll() as $prod) { ?>
      <tr class="data-row">
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?=$prod->getNome() ?></span>
        </td>
        ...
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?=$prod->getPreco() ?></span>
        </td>

        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?=$prod->getQuantidade() ?></span>
        </td>

        <td class="data-grid-td">
           <span class="data-grid-cell-content">
              <?php foreach($prod->getCategorias() as $cats) { ?>   
                <?=$cats->getNome() ?> 
                  <Br />
              <?php } ?>
          </span>
        ...
        <td class="data-grid-td">
          <div class="actions">
            <div class="action edit"><a href="products.php?funcao=edit&id=<?=$prod->getId() ?>"<span>Edit</span></a></div>
            <div class="action delete"><a href="products.php?funcao=delete&id=<?=$prod->getId() ?>"<span>Delete</span></a></div>
          </div>
        </td>
      </tr>
